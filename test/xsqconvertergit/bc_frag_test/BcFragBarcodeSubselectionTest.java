 ...
 * @author root
 */
public class BcFragBarcodeSubselectionTest {
    ...
    public BcFragBarcodeSubselectionTest() {
    }
    ...
    public static void setUpClass() {
        ...
        String testXSQFilePath = BcFragBarcodeSubselectionTest.class.getResource("HU03_20121219_MaartjeChip2R_Nico_minimalTest_L02.xsq").getFile();
    ...
    public static void tearDownClass() {
        try {
            ...
            Logger.getLogger(BcFragBarcodeSubselectionTest.class.getName()).log(Level.SEVERE, null, ex);
        }
