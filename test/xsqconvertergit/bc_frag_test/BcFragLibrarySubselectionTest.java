 ...
 * @author root
 */
public class BcFragLibrarySubselectionTest {
    ...
    public BcFragLibrarySubselectionTest() {
    }
    ...
    public static void setUpClass() {
        ...
        libraries = Arrays.asList(new String[]{"10B32DJ","5SIDJ" });           
        
        String testXSQFilePath = BcFragLibrarySubselectionTest.class.getResource("HU03_20121219_MaartjeChip2R_Nico_minimalTest_L02.xsq").getFile();
    ...
    public static void tearDownClass() {
        try {
            ...
            Logger.getLogger(BcFragLibrarySubselectionTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void testConversionMetricsFile() {
        ...
        File expectedConversionMetricsFile  = new File(getClass().getResource("conversionMetricsOnlyFirst2.txt").getFile());        
       
        junitx.framework.FileAssert.assertEquals("Conversion metrics files is not like expected", expectedConversionMetricsFile, testConversionMetricsFile );                 
    ...
    @Test
    public void testOnly2librariesConverted() 
    {
        String[] directories = testXSQOutputDir.list(new FilenameFilter() {
        @Override
        ...
        Assert.assertTrue( "More than 2 libraries are converted", directories.length == 2);
    }
