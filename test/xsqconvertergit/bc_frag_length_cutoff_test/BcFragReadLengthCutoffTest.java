 ...
 */
package xsqconvertergit.bc_frag_length_cutoff_test;
 ...
 * @author root
 */
public class BcFragReadLengthCutoffTest {
    ...
    public BcFragReadLengthCutoffTest() {
    }
    ...
    public static void setUpClass() {
        ...
        String testXSQFilePath = BcFragReadLengthCutoffTest.class.getResource("HU03_20121219_MaartjeChip2R_Nico_minimalTest_L02.xsq").getFile();
    ...
    public static void tearDownClass() {
        try {
            ...
            Logger.getLogger(BcFragReadLengthCutoffTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void testFastQFiles() {
        ...
        for(String library : libraries)
        {
            for(String tag: tags)
            {
                ...
                junitx.framework.FileAssert.assertEquals("Fastq file "+testFastQFile.getPath()+" is not like expected", expectedFastQFile, testFastQFile);  
            }
        }         
    }     
