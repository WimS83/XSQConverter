 ...
 */
package xsqconvertergit.bcmp_mismatch2_test;

import xsqconvertergit.bcmp_test.*;
 ...
 * @author root
 */
public class BcMPMismatch2Test {
    ...
    public static void tearDownClass() {
        try {
            ...
            Logger.getLogger(BcMPMismatch2Test.class.getName()).log(Level.SEVERE, null, ex);
        }
